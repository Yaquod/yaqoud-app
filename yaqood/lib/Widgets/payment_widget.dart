...
class _PaymentWidgetState extends State<PaymentWidget> {
  ...
  Future<void> _fetchUserCards() async {
    ...
    try {
      final List<SavedCard>? fetchedCards = await _paymentService.getSavedCards();
      if (mounted) {
        setState(() {
      ...
      if (mounted) showSnackBar(context: context, message: "Error loading cards: $e");
    } finally {
  ...
  Future<void> _processPaymentAndConfirmTrip() async {
    if (_selectedCard == null) {
      showSnackBar(context: context, message: "Please select a payment card first");
      return;
    }
    ...
    try {
      ...
      if (isPaid && mounted) {
        showSnackBar(context: context, message: "Payment successful!", isError: false);
        widget.onPaymentSuccess(); 
      }
    } catch (e) {
      if (mounted) showSnackBar(context: context, message: "Payment Failed: $e");
    } finally {
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(card.cardSubtype.toUpperCase()),
                    trailing: isSelected 
